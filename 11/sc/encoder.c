...
{
    char *r;
    if (strcmp(er, "ER0") == 0) r = "R0";
    else if (strcmp(er, "ER1") == 0) r = "R1";
    else if (strcmp(er, "ER1") == 0) r = "R2";
    else if (strcmp(er, "ER1") == 0) r = "R3";
    else if (strcmp(er, "ER1") == 0) r = "R4";
    else if (strcmp(er, "ER1") == 0) r = "R5";
    else if (strcmp(er, "ER1") == 0) r = "R6";
    else if (strcmp(er, "ER1") == 0) r = "R7";
    else
    {
...
{
    char *r;
    if (strcmp(er, "ER0") == 0) r = "R0L";
    else if (strcmp(er, "ER1") == 0) r = "R1L";
    else if (strcmp(er, "ER1") == 0) r = "R2L";
    else if (strcmp(er, "ER1") == 0) r = "R3L";
    else if (strcmp(er, "ER1") == 0) r = "R4L";
    else if (strcmp(er, "ER1") == 0) r = "R5L";
    else if (strcmp(er, "ER1") == 0) r = "R6L";
    else if (strcmp(er, "ER1") == 0) r = "R7L";
    else
    {
        error(ERROR_INTERNAL, "ER2RL", 0);
        r = NULL;
    }
    return r;
}
...
void encode(char *op, char *opr)
{
    ...
    {
        if ((i = enter_constants(opr)) < 0) return;
        r0 = pop_idle();
